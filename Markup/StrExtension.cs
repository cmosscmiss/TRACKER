...
///
/// Uso: <c>Text="{loc:Str Key=General_Language_Label}"</c> (declarar <c>xmlns:loc="using:MM4LB.Markup"</c>).
/// </summary>
public sealed class StrExtension : MarkupExtension
{
    /// <summary>Clave del recurso (debe existir en <see cref="MM4LB.Helpers.LocKeys"/> y en el .resx).</summary>
